...
void span_entry_atomic_store(struct span_timestamped_base *dst, struct span_timestamped_base entry)
{
...
struct span_timestamped_base span_entry_atomic_load(const struct span_timestamped_base *entry_ptr)
{
