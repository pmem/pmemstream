...
#
# exec_functions.cmake - helper functions for execution's cmake scripts (used in tests' workflows)
#

# Sets testing path, based on TEST_DIR ('PARENT_DIR' here) set in the top-level CMake.
set(DIR ${PARENT_DIR}/${TEST_NAME})

set(SUPPRESSIONS_DIR ${TEST_ROOT_DIR}/cmake/suppressions)
...
function(pmempool_execute)
	# XXX: do we need this function? if so we need to set proper lib dirs
