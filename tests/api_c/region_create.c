...
void valid_input_test(char *path)
{
	...
	UT_ASSERTeq(pmemstream_region_usable_size(env.stream, region), region_size);
...
void null_stream_test(char *path)
{
	...
	UT_ASSERTeq(pmemstream_region_usable_size(NULL, region), 0);
...
void invalid_region_test(char *path)
{
	...
	UT_ASSERTeq(pmemstream_region_size(env.stream, invalid_region), 0);
	UT_ASSERTeq(pmemstream_region_usable_size(env.stream, invalid_region), 0);
