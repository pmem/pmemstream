...
void test_stream_from_map(char *path, size_t file_size, size_t blk_size)
{
	...
	UT_ASSERTeq(pmemstream_committed_timestamp(s), PMEMSTREAM_INVALID_TIMESTAMP + 1);
	UT_ASSERTeq(pmemstream_persisted_timestamp(s), PMEMSTREAM_INVALID_TIMESTAMP + 1);
