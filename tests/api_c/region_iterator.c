...
/* XXX: Uncomment when streaming iterator will be implemented (1/2) */
/*
...
void null_iterator_test(char *path)
{
	...
	region = pmemstream_region_iterator_get(NULL);
	UT_ASSERTeq(region.offset, SLIST_INVALID_OFFSET);
...
int main(int argc, char *argv[])
{
	...
	/* XXX: Uncomment when streaming iterator will be implemented (2/2) */
