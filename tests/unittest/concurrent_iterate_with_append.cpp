...
static constexpr size_t stream_size = max_entry_size * max_entry_size * concurrency * 10 /* 10x-margin */;
...
int main(int argc, char *argv[])
{
	...
	return run_test([&] {
		...
		std::string rapidcheck_config = "noshrink=1\" max_size=\"" + std::to_string(max_entry_size) + "\"";
