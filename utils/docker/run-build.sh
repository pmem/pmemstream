...
function tests_package() {
	...
	compile_example_standalone basic_iterate
	run_example_standalone basic_iterate ${WORKDIR}/build/testfile
	run_example_standalone basic_iterate ${WORKDIR}/build/testfile

	echo "C++ example, should print data from previous example:"
	compile_example_standalone visual_iterator
	run_example_standalone visual_iterator ${WORKDIR}/build/testfile
