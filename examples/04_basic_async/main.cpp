...
int main(int argc, char *argv[])
{
	...
	// XXX: get proper timestamp from async_append (refactor API)
	...
	committed_timestamp = pmemstream_committed_timestamp(stream);
	persisted_timestamp = pmemstream_persisted_timestamp(stream);
	printf("Timestamp commited: %lu, timestamp persisted: %lu\n", committed_timestamp, persisted_timestamp);
