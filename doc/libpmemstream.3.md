...
:	Creates new pmemstream instance from *pmem2_map* `map`
	See **libpmem2**(7) for details on creating such map structure. `block_size` defines alignment
	of regions - it must be a power of 2 and multiple of CACHELINE size.
